...
namespace Hahn.ApplicatonProcess.July2021.Web.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            _logger.LogInformation("The Endpoint Get User by id has been accessed");
        ...
        {
            _logger.LogInformation("The Endpoint to create new Users has been accessed");
        ...
        {
            _logger.LogInformation("The Endpoint to update Users has been accessed");
            var user = _mapper.Map<User>(userDTO);
            user.Id = id;
        ...
        {
            _logger.LogInformation("The Endpoint to delete Users has been accessed");
